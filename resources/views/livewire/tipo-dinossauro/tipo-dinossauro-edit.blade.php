<div class="py-4">
    <x-slot name="header">
        <p class="text-2xl font-bold text-yellow-900 underline">Editar tipo</p>
    </x-slot>
    ...
    <div class="mt-5 py-8 px-12 bg-white flex justify-center">
        <a
            ...
            href="{{ route('tipos-dinossauros.index') }}"
        >
            Voltar
        </a>
        <form
            action=""
            wire:submit.prevent="updateTipoDinossauro"
